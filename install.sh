...
if [[ "$EUID" = 0 ]]; then
 	...
 	ufw enable
 	ufw allow xxx/tcp # open port for web server
 	ufw allow yyy/tcp # open port for ftp data
 	ufw allow zzz/tcp # open port for ftp commands
	ufw allow  # open port for ftp passive mode
